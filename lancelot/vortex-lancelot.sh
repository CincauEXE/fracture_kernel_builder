...
# Kernel Sources
git clone --depth=1 https://github.com/CincauEXE/kernel_redmi_mt6768 -b base-r-oss-uv-vortex vortex
...
function zipping() {
    cd AnyKernel || exit 1
    zip -r9 [$DATE2][GCC][$LINUXVER][R-OSS]$KERNEL_NAME[$DEVICE_CODENAME]$HEADCOMMITID.zip *
    cd ..
}
check
compile
